...
(function() {
    ...
    var metro_map={"San Francisco Bay Area": {city: "San Francisco Bay Area", state: "CA", country:"US"},
        "Greater Los Angeles Area": {city: "Greater Los Angeles Area", state: "CA", country:"US"},
                   "Greater San Diego Area": {city: "Greater San Diego Area", state: "CA", country:"US"},
                   "Greater Denver Area": {city: "Greater Denver Area", state: "CO", country:"US"},
                   "Washington D.C. Metro Area": {city: "Washington D.C. Metro Area", state:"DC", country:"US"},
                   "Greater Chicago Area": {city:"Greater Chicago Area","state":"IL","coutnry":"US"},
                   "Greater Indianapolis Area": {city:"Greater Indianapolis Area","state":"IN","coutnry":"US"},
                   "Greater Louisville Area": {city:"Greater Louisville Area","state":"KY","coutnry":"US"},
                  "Greater Boston Area": {city: "Greater Boston Area", state: "MA", country:"US"},
                  "Greater Philadelphia Area": {city: "Greater Philadelphia Area", state: "PA", country:"US"},
                  "Greater Detroit Area": {city: "Greater Detroit Area", state: "MI", country:"US"},
                   "Greater Minneapolis-St. Paul Area": {city: "Greater Minneapolis-St. Paul Area", state: "MN", country:"US"},
                  "Greater St. Louis Area": {city: "Greater St. Louis Area", state: "MO", country:"US"},
                  "Greater Kansas City Area": {city: "Greater Kansas City Area", state: "MO", country:"US"},
                   "Greater New York City Area": {city: "Greater New York City Area", state: "NY", country:"US"},
                   "Greater Memphis Area": {city: "Greater Memphis Area", state: "TN", country:"US"},
                  "Greater Nashville Area": {city: "Greater Nashville Area", state: "TN", country:"US"},
                  "Greater Seattle Area": {city: "Greater Seattle Area", state: "WA", country:"US"}};
    ...
    function search_linkedin(url)
    {
        var navsearch="";
        var input_box;
        var i,j;
        var name_part=url.replace(/https?:\/\/www\.linkedin\.com\/in\//,"").replace(/\/.*$/,"");
        var name_split=name_part.split("-");
        if(/[\d]/.test(name_split[name_split.length-1])) name_split.pop();
        var new_name="";
        for(i=0; i < name_split.length; i++)
        {
            new_name=new_name+name_split[i];
            if(i<name_split.length-1) new_name=new_name+" ";
        }
        navsearch=document.getElementsByClassName("nav-search-typeahead")[0];
        input_box=navsearch.getElementsByTagName("input")[0];
                input_box.focus();
       ...
       /* for(x in input_box)
        {
            console.log("input_box["+x+"]="+input_box[x]);
        }*/
          input_box.value=new_name;
         input_box.focus();


        console.log("input_box.oninput="+input_box.oninput);
        console.log("input_box.keydown="+input_box.onkeydown);

        setTimeout(function()
                   {

       var typebutton=document.getElementsByClassName("search-typeahead-v2__button")[0];
            typebutton.click();
            typebutton.click();
       ...
       // setTimeout(function() { input_box.focus(); do_clickofresult(); }, 2500);
    }
    function do_clickofresult()
    {

        var res_list=document.getElementsByClassName("results-list")[0];
        var first_choice=res_list.getElementById(res_list.id+"-result-0");
        if(first_choice === null) console.log("first choice is null");
        else
        {
            console.log("first_choice="+first_choice.innerText);
            first_choice.focus();
    ...
    function do_linkedin()
    {
       ...
       // window.scrollTo(0,document.body.scrollHeight);
        try
        {
            ...
            var full_name=parse_name(name_sec.innerText);//.replace(/([A-Z]+\s*)*$/,""));
...
console.log("Checkpoint 3");
            ...
            result.lastName=full_name.lname.replace(/,$/,"");
...
console.log("Checkpoint 4");
    ...
    else if(window.location.href.indexOf("linkedin.com")!==-1)
    {
        ...
        //    if(GM_getValue("url")!=="")  search_linkedin(GM_getValue("url"));
