...
(function() {
    ...
    var my_query = {};
    var bad_urls=[];
    var MTurk=new MTurkScript(20000,200,[],begin_script,"A2UVAPBUKP3K7W",false);
    ...
    function init_Query()
    {
        ...
        my_query={name:wT.rows[1].cells[1].innerText,address:wT.rows[2].cells[1].innerText,city:wT.rows[3].cells[1].innerText,
