...
(function() {
    ...
    var my_query = {};
    var bad_urls=[];
    var MTurk=new MTurkScript(20000,0,[],begin_script,"A1IHW34XTHH3VD");
    ...
    function init_Query()
    {
        ...
        var url="https://ecatalog.smpcorp.com/STD/api/product/partsearch?filter="+my_query.part;
