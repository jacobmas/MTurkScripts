...
// @require https://raw.githubusercontent.com/jacobmas/MTurkScripts/f3560dbdee16be11c74c3dce508e6f9cb62483b9/Govt/Government.js
...
(function() {
    ...
    var MTurk=new MTurkScript(20000,750+(Math.random()*1000),[],begin_script,"A1S0R3W9HX8QM5",true);
    ...
    function query_promise_then(result) {
        var  url=result;
        var promise=MTP.create_promise(url,Gov.init_Gov,parse_gov_then,function() { GM_setValue("returnHit",true); },
                                       {dept_regex_lst:[],title_regex_lst:[/Owner/,/Manager/,/Director/],debug:false});
    }

    function parse_gov_then(result) {
        console.log("Gov.contact_list=",Gov.contact_list);
    }
    ...
    function init_Query()
    {
        ...
        my_query={name:document.querySelector("crowd-form a").innerText,title:document.querySelectorAll("crowd-form a")[1].innerText, fields:{},done:{},
		  try_count:{"query":0},
		  submitted:false};
	console.log("my_query="+JSON.stringify(my_query));
        var search_str=my_query.name+" "+my_query.title.replace(/ OR .*$/,"");
