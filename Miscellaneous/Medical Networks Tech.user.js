...
// @version      0.1
// @description  Varsha also TODO: update for non-dermatology if necessary!
// @author       You
...
// @require https://raw.githubusercontent.com/jacobmas/MTurkScripts/d85058bc98ccf994dd73bf4054e8972f16401dc7/js/MTurkScript.js
...
(function() {
    ...
    var bad_urls=['.aad.org', 'affiliatejoin.com/','allpeople.com', '/biographymask.com', '.birdeye.com','.bizapedia.com','/bizstanding.com',
                  '.caredash.com',  '.corporationwiki.com',
                  'dermatologistdiscover.com',
                  '.doctor.com', '.doctorhelps.com', '.doximity.com', '.ehealthscores.com', '.everydayhealth.com','/ezdoctor.com',
                  '/findadermatologist.com',
                  'findatopdoc.com', '.healthcare4ppl.com', 'healthcare4ppl.com',
                  '.healthcare6.com', '.healthgrades.com', '/healthprovidersdata.com', '.healthsoul.com',
                  '.justdocsearch.com','licensefiles.com', '.linkedin.com','.logosdatabase.com',
                  '.manta.com','.md.com',
                  '.medicarelist.com', '.medicinenet.com', '.mturkcontent.com','.mylife.com', '.npidb.com', '/npino.com', '/npiprofile.com',

                  '/opengovus.com','/pressrelease.healthcare','/pubprofile.com','/radaris.com','.ratemds.com',
                  '.sharecare.com','/site-stats.org','.spoke.com',
                  '.topnpi.com', '.usnews.com', '.vitadox.com', '.vitals.com', 'vivacare.com', '.webmd.com', '.wellness.com',
                  '.whodoyou.com','.wsimg.com','.yahoo.com',
                  '.yellowpages.com', '.yelp.com', '.zocdoc.com','.zoominfo.com'];
    /* TODO should be requester #, last field should be if it's crowd or not */
    var MTurk=new MTurkScript(60000,1000+(Math.random()*1000),[],begin_script,"A368JNAWVCNUOW",false);
    ...
    function query_response(response,resolve,reject,type) {
        ...
        try
        {
            ...
            if(b_context&&(parsed_context=MTP.parse_b_context(b_context))) {
                if(type==="query2" && parsed_context.Title && !/^Dermatology$/.test(parsed_context.Title)) {
                 ...
                 else if(type==="query" && parsed_context.people!==undefined && parsed_context.people[0].url && my_query.try_count[type]===0) {
        ...
        if(type == "query" && healthgrades_url) {
