...
(function() {
    'use strict';
    var my_query = {};
    var bad_urls=["opencompanies.nl","facebook.com","twitter.com"];
    var MTurk=new MTurkScript(20000,200,[],begin_script,"AXBZ5UOB39RDW");
...
//        reject("Nothing found");
    ...
    function init_Query()
    {
        ...
        my_query={name:wT.rows[0].cells[1].innerText,street:wT.rows[1].cells[1].innerText,city:wT.rows[2].cells[1].innerText,country:wT.rows[3].cells[1].innerText};
