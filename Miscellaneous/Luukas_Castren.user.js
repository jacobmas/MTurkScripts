...
// @version      0.1
// @description  Clone of generic email for bing Chris Richmond
// @author       You
...
(function() {
    ...
    var MTurk=new MTurkScript(60000,250+Math.random()*250,[],begin_script,"A237XQ0YKNKXRH",true);
    ...
    function add_to_sheet() {
        ...
        if(field) field.value=my_query.fields.email;
    }
...
//        console.log("result="+JSON.stringify(result));
    ...
    function init_Query() {
       ...
       // var wT=document.getElementById("DataCollection").getElementsByTagName("table")[0];
        ...
        my_query={url:document.querySelector("form a").href,fb_url:"",insta_url:"",person_list:"",found_fb:false,
