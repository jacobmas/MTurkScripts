...
(function() {
    ...
    var MTurk=new MTurkScript(75000,2000+(Math.random()*1000),[],begin_script,"A1Y0NDLYARQRZF",true);
...
name, priority (lower is better) */
   ...
   logo_counter++;
    ...
    function submit_if_done() {
        ...
        for(x in my_query.fields) if(!my_query.fields[x]&&my_query.fields[x]!=="0" && my_query.fields[x]!==0) is_done=false;
...
AggParser.parse_instagram=function(doc,url,resolve,reject) {
    ...
    function find_insta(doc,url,resolve,reject) {
        ...
        if(MTP.is_bad_page(doc,url)) {
            reject("Failed to load, bad site");
            return;
        }
	...
	console.log("my_query="+JSON.stringify(my_query));
        ...
        var promise=MTP.create_promise(url,find_insta,find_insta_then,function(message) {
            ...
            if(/No insta found/.test(message)) {
                ...
                queryPromise.then(find_insta_then)
                    ...
                    console.log("Failed at this queryPromise " + val); GM_setValue("returnHit",true); });
                                ...
                                console.log("trying again without www");
                ...
                let promise2=MTP.create_promise("http://"+document.querySelector("a").innerText,find_insta,find_insta_then,function(message) {
                    if(/No insta found/.test(message)) {
                        ...
                        my_query.fields.IGurl="DEAD SITE";
                        my_query.fields.IGcount="0";
                        submit_if_done();
                        return;
                    }
