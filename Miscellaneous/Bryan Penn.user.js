...
// @version      0.1
// @description  Find Website Email
// @author       You
...
(function() {
    ...
    var MTurk=new MTurkScript(20000,750+(Math.random()*1000),[],begin_script,"AHWZCQ4A158B6",true);
    ...
    function init_Query()
    {
        ...
        my_query={name:p[0].innerText.replace(/^[^:]*:\s*/,"").trim(),street:p[1].innerText.replace(/^[^:]*:\s*/,"").trim(),
                  place:p[2].innerText.replace(/^[^:]*:\s*/,"").trim(),fields:{Email:""},done:{query:false},
		  try_count:{"query":0},
		  submitted:false};
	console.log("my_query="+JSON.stringify(my_query));
        var search_str=my_query.name+" "+my_query.place;
