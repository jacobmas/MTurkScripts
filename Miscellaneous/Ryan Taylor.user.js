...
// @version      0.1
// @description  Parse SEC proxy etc. Code taken from Natasha Nurjadin
// @author       You
...
(function() {
    ...
    var my_query = {};
    var bad_urls=[];
    var MTurk=new MTurkScript(20000,2000+(Math.random()*1000),[],begin_script,"A3A5NZ51HVCOPD",true);
    ...
    function init_Query()
    {
        ...
        var input_fields=document.querySelectorAll("crowd-form div > div p");
        console.log(input_fields[0].innerText);
