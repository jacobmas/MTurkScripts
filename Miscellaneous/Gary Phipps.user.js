...
(function() {
    'use strict';
    var my_query = {};
    var bad_urls=["spokeo.com"];
    var MTurk=new MTurkScript(20000,200,[],begin_script,"A2N94CACCP1WIH",true);
    var MTP=MTurkScript.prototype;
    function is_bad_name(b_name)
    {
        if(MTP.matches_names(b_name,my_query.name) || b_name.toLowerCase().indexOf(my_query.name)!==-1) return false;
        return true;
    }
