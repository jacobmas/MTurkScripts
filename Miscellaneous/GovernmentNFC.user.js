...
//        GM_setValue("returnHit",true);
    ...
    */
    ...
    function cityManager_paste(e) {
        ...
        if(parsed.phone) my_query.fields.cityManagerPhone=parsed.phone;
        if(parsed.email) my_query.fields.cityManagerEmail=parsed.email;
         if(parsed.title) my_query.fields.cityManagerTitle=parsed.title;
        submit_if_done();
    ...
    function init_Query()
    {
        ...
        my_query={url:dont,fields:{}};
        GM_setClipboard(my_query.url);
        document.getElementById("cityManagerFirstName").addEventListener("paste",cityManager_paste);
