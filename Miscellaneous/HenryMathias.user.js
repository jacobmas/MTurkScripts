...
// @require https://raw.githubusercontent.com/jacobmas/MTurkScripts/3589c88d332250bb8a64b4af58d36f788512d381/Govt/Government.js
...
(function() {
    ...
    var MTurk=new MTurkScript(30000,200,[],begin_script,"A3ADJDGNCWPV7X",true);
        ...
        if(is_done &&
           !my_query.submitted && (my_query.submitted=true) && (MTurk.submitted=true)) {
            if(my_query.fields.email.length>0) {
                if(my_query.fields.first_name.length===0) document.getElementById("firstname").value="none";
                if(my_query.fields.last_name.length===0) document.getElementById("lastname").value="none";
...
//        console.log(nlp_temp);
    ...
    function paste_person(e) {
        ...
        if(ret.name&&ret.title) {
            ...
            my_query.fields.ceo=ret.name;
            my_query.fields.email=ret.email||"";
        }
        else {
     ...
     function PersonQual(curr) {
        ...
        if(nlp_out.length>0) this.quality+=2;
         if(this.email!=="na" && this.email.indexOf("@")!==-1) this.quality+=1;
    }
    ...
    function gov_promise_then() {
        ...
        if(person_list.length>0) {
            ...
            my_query.fields.job_title=person_list[0].title;
            my_query.fields.first_name=person_list[0].first;
            my_query.fields.last_name=person_list[0].last;
        }
    ...
    function init_Query()
    {
        ...
        var crowdemail=document.querySelector("crowd-input[name='ceo']");
        crowdemail.addEventListener("paste",paste_person);
       // var wT=document.getElementById("DataCollection").getElementsByTagName("table")[0];
        //var dont=document.getElementsByClassName("dont-break-out");
        my_query={name:"",try_count:{url:0,fb:0},
                  email_list:[],url:document.querySelector("form a").href,


                  fields:{email:"","ceo":""},url_list:[],
...
//     my_query.url=
        ...
        var title_regex_lst=[/Admin|Administrator|Supervisor|Manager|Director|Founder|Owner|Officer|Secretary|Assistant|CEO|CTO/i];
        ...
        var gov_promise=MTP.create_promise(my_query.url,Gov.init_Gov,gov_promise_then,function(result) {
            ...
            if(my_query.fields.email.length===0) my_query.fields.email="na@na.com";
