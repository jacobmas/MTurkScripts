...
// @require https://raw.githubusercontent.com/jacobmas/MTurkScripts/5869a40d1fedc27ce0e988ea6bae79a928b4bb7/Email/MailTester.js
...
(function() {
    ...
    var MTurk=new MTurkScript(20000,750+(Math.random()*1000),[],begin_script,"A1FTOK480K7Q06",true);
    ...
    function submit_if_done() {
       ...
       function name_paste(e) {
        ...
        if(ret.name===undefined) {
            my_query.fields.contactName=ret.name;
            return;
        }
        if(ret.title===undefined) ret.title="";
        var fullname=MTurkScript.prototype.parse_name(ret.name);
        my_query.fields.contactEmail=ret.email?ret.email:"";
        my_query.fields.contactName=ret.name||"";
        my_query.fields.contactTitle=ret.title||"";
