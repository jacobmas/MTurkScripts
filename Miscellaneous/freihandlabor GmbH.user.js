// ==UserScript==
// @name         freihandlabor GmbH
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  find European foundation website
// @author       You
...
(function() {
    'use strict';
    var my_query = {};
    var bad_urls=["fundraisio.ch", "stiftungschweiz.ch", "moneyhouse.ch"];
    ...
    function query_response(response,resolve,reject,type) {
	    ...
	    if(b_context&&(parsed_context=MTP.parse_b_context(b_context))) {
            ...
            for(i=0; i < b_algo.length&& i<1; i++) {
                ...
                if(!MTurkScript.prototype.is_bad_url(b_url, bad_urls) && /(\.org|\.ch|\.com)$/.test(b_url) && !MTurkScript.prototype.is_bad_name(b_name,my_query.name,p_caption,i)
