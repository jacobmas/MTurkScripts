...
(function() {
    ...
    function query_promise_then(result) {
        ...
        var promise_list=[];
        promise_list.push(MTP.create_promise(my_query.practice_url,Address.scrape_address,address_scrape_then,function(response) {
            console.log("Failed address"); },{type:"",depth:0}));
        promise_list.push(MTP.create_promise(my_query.practice_url,scrape_practice_page,scrape_practice_then,function(response) {
            console.log("Failed practice"); }));

    }

    function scrape_practice_page(doc,url,resolve,reject) {
        //itemtype="http://schema.org/Physician"
    }

    function scrape_practice_then(result) {
        my_query.done.practice=true;
        add_to_sheet();
    }
    ...
    function query_web_md(doc,url,resolve,reject) {
        ...
        try {
            ...
            .replace("Pediatric Pulmonology","Pulmonary Medicine").replace(/^Pain .*$/,"Pain Medicine");
    ...
    function init_Query()
    {
      ...
      //var end_re=/[A-Z][a-z]+(\s)
        ...
        document.querySelectorAll("[name*='website']").forEach(function(elem) {
        ...
        my_query={name:name_match?name_match[1]:'',state:state_match?reverse_state_map[state_match[1]]:'',url:"",fields:
                  {},done:{address:false,other:false},
