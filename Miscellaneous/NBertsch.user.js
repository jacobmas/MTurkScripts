...
(function() {
    ...
    var MTurk=new MTurkScript(20000,750+(Math.random()*500),[],begin_script,"A287QLBQINKAGG",true);
    ...
    function query_response(response,resolve,reject,type) {
	    ...
	    if(b_context&&(parsed_context=MTP.parse_b_context(b_context))) {
            ...
            if(parsed_context.Address) {
                my_query.fields.address=new Address(parsed_context.Address);
                resolve("");
                return;
            }
        }
            if(lgb_info&&(parsed_lgb=MTP.parse_lgb_info(lgb_info))) {
                ...
                if(parsed_lgb.address) {
                    my_query.fields.address=new Address(parsed_lgb.address);
                    resolve("");
                    return;
                }
            }
            if(b_address) {
                my_query.fields.address=new Address(b_address.innerText.trim());
                    resolve("");
                    return;
            }
    ...
    function query_promise_then(result) {
        my_query.address=my_query.fields.address;
        my_query.fields.address=my_query.address.address1;
    ...
    function init_Query()
    {
        ...
        var i;
       var p=document.querySelectorAll("crowd-form div p")[1].innerText.trim().replace(/[^:]*:\s*/,"").trim();
        my_query={name:p,fields:{},done:{},
		  try_count:{"query":0},
		  submitted:false};
	console.log("my_query="+JSON.stringify(my_query));
        var search_str=my_query.name+" home depot address ";
