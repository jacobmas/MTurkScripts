// ==UserScript==
// @name         MelissaHalliburtonExpedia
...
(function() {
	...
	console.log("my_query="+JSON.stringify(my_query));
        var search_str;
        const queryPromise =MTP.create_promise(url, parse_url, submit_if_done, function() { GM_setValue("returnHit",true); });
    }
