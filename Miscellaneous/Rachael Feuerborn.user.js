...
(function() {
    ...
    var my_query = {};
    var bad_urls=[];
    var MTurk=new MTurkScript(20000,200,[],begin_script,"A1K7IWNAZWX1EH",true);
    var MTP=MTurkScript.prototype;
    function is_bad_name(b_name)
    {
        if(MTP.matches_names(my_query.name,b_name) || b_name.indexOf(my_query.name)!==-1) return false;
        return true;
    }
