...
(function() {
    'use strict';
    var my_query = {};
    var bad_urls=["spokeo.com","mylife.com"];
    var MTurk=new MTurkScript(20000,200,[],begin_script,"A6F2IPUML66ZK",false);
    var MTP=MTurkScript.prototype;
    function is_bad_name(b_name)
    {
        b_name=b_name.replace(/\s+[\(-]+\s*.*$/,"").replace(/[,\":]+/g,"");
        my_query.name=my_query.name.replace(/[,\":]+/g,"");
    ...
    function query_response(response,resolve,reject,type) {
	    ...
	    if(b_context&&(parsed_context=MTP.parse_b_context(b_context))) {
            ...
            if(parsed_context.url && !MTP.is_bad_url(parsed_context.url,bad_urls,5) && (resolve(parsed_context.url)||true)) return;
                 }
    ...
    function init_Query()
    {
        ...
        my_query={name:wT.rows[0].cells[1].innerText,fields:{web_url:""},done:{},submitted:false};
