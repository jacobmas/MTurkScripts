...
// @version      0.1
// @description  Company website, linkedin
// @author       You
...
(function() {
    ...
    var MTurk=new MTurkScript(20000,750+(Math.random()*1000),[],begin_script,"A3W3EM9AP6A7KK",true);
    ...
    function query_response(response,resolve,reject,type) {
	    ...
	    if(b_context&&(parsed_context=MTP.parse_b_context(b_context))) {
            ...
            if(type==="query" && parsed_context.url) {
                if(parsed_context.LinkedIn) my_query.fields.linkedin_url=parsed_context.LinkedIn;
                resolve(parsed_context.url); return;
            }
        }
		   ...
		   && (b1_success=true)) break;
                if(type==="linkedin" &&  !MTurkScript.prototype.is_bad_name(b_name,my_query.name,p_caption,i)
		   && (b1_success=true)) break;
            }
    ...
    function linkedin_promise_then(result) {
        if(!my_query.fields.linkedin) my_query.fields.linkedin=result;
    ...
    function init_Query()
    {
       ...
       var name=document.querySelector("crowd-form strong").innerText.trim();
        my_query={name:name,fields:{website:"",linkedin:""},done:{"query":false,linkedin:false},
	...
	console.log("my_query="+JSON.stringify(my_query));
        ...
        linkedinPromise.then(linkedin_promise_then)
            .catch(function(val) {
            console.log("Failed at this linkedinPromise " + val); GM_setValue("returnHit",true); });
    }
