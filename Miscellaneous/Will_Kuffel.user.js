...
(function() {
    ...
    var MTurk=new MTurkScript(20000,750+(Math.random()*1000),[],begin_script,"A15JBGSG1KIZJH",false);
    ...
    function query_response(response,resolve,reject,type) {
        ...
        var re=/See all ([\d]*) employees on LinkedIn/i,match;
        try
        {
	...
	console.log("my_query="+JSON.stringify(my_query));
        var search_str=my_query.website+" site:linkedin.com/company see all \"employees on Linkedin\"";
