...
(function() {
    var my_query = {};
    var bad_urls=[];
    var MTurk=new MTurkScript(30000,200,[],begin_script,"A36BAPYNDDCH4N");
 ...
 * contact_response Here it searches for an email TODO:FIX */
    var contact_response=function(doc,url,extra) {
        ...
        var contact_regex=/(Contact|About|Legal|Team|Coach|Policy|Policies)/i,bad_contact_regex=/^\s*(javascript|mailto):/i;
