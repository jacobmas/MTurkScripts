...
(function() {
    ...
    var bad_urls=["www.mapquest.com","local.yahoo.com","yelp.com","birdeye.com","findglocal.com",
                 ...
                 "bloomberg.com","crunchbase.com","palico.com","pehub.com","startupranking.com","secondarylink.com",
                 "vbprofiles.com","linkedin.com","wikipedia.org","jobspotting.com","youtube.com","github.com"];
       ...
       // var g1_success=false;
        ...
        try
        {
            ...
            for(i=0; i < b_algo.length; i++)
            {
                ...
                {
                    document.getElementsByName("web_url")[0].value=fix_url(inner_a[0].href);
                    check_and_submit();
                    return;
                }
            }
...
//        if(!first_try) google_search_str=google_search_str+" "+my_query.country;
        ...
        var search_URIBing='https://www.bing.de/search?q='+encodeURIComponent(search_str)+"&first=1&rdr=1";
