...
var default_bad_urls=[".alibaba.com",".amazonaws.com",".business.site",".crunchbase.com",".dictionary.com","facebook.com",".google.com",
			  ...
			  '.healthgrades.com','.vitals.com','.medicarelist.com','.healthcare4ppl.com','.yelp.com','.zocdoc.com',
                 ...
                 '.healthlynked.com','.spokeo.com','/obituaries/','.tripadvisor.com','.addresses.com','/allpeople.com','.allstate.com','.amazon.com','.ancientfaces.com','.angmedicare.com','angi.com','/arrestfacts.com','.arounddeal.com',
                  '.avvo.com','.bbb.org',
...
MTurkScript.prototype.is_crowd_ready=function() {
	...
	else if(document.querySelector("crowd-form") && !document.querySelector("crowd-form").disabled) return true;
...
MTurkScript.prototype.fix_emails=function(doc,url) {
    ...
    for(i=0; i < links.length; i++) {
		...
		links[i].href=links[i].href.replace(/^.*\#MAIL:/,"mailto:").replace(/[\(\[]{1}at[\]\)]{1}/,"@").replace(/[\(\[]{1}dot[\]\)]{1}/,".");
