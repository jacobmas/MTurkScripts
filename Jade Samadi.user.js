...
(function() {
    ...
    function query_response(response,resolve,reject) {
        ...
        {
            document.getElementsByName("EmailAddress")[0].value=email_sec.getElementsByClassName("public-register-data")[0].innerText;
        }
        else if(phone_sec!==null && phone_sec!==undefined)
        {
            document.getElementsByName("EmailAddress")[0].value=phone_sec.getElementsByClassName("public-register-data")[0].innerText;
        }
