...
var Gov=Gov||{contact_list:[],scripts_loaded:{},scripts_total:{},area_code:"",
	      ...
	      title_prefix_regex:/^(Director|Mayor|(Chief ([Oo]f Police)?)|Police Chief|Chief|Constable|Councilman|Councilwoman|Secretary|Sheriff|Sergeant|Patrol Officer|Lieutenant|Detective|Sgt\.|Lt\.)((?:\s+[A-Z0-9\"][\-\.\'a-z0-9]+[0-9\-\.\'\"a-zA-Z]*)+)(.*)$/,
	      ...
	      contact_regex:/Contact|Email|Directory|(^About)|(^Departments)|Staff|Officials|^(Town|City) Hall\s*$|(^Government)|(Our Team)|(Personnel)|(Our People)/i};
