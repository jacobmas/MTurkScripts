// ==UserScript==
// @name         LinkedinScriptSloane
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Speeds up Sloane tasks by allowing efficient copy/paste from Linkedin
// @author       You
...
(function() {
    ...
    window.addEventListener("keydown",function(e) {
        ...
        var get_Exp=function(e) {
            ...
            var i_len;
            var max_exp_len=10;
            i_len = expProfiles.length > max_exp_len ? max_exp_len : expProfiles.length;
            var i_count=0;
