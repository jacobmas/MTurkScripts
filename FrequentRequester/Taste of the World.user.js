...
(function() {
    'use strict';
    var my_query = {};
    var bad_urls=["/addr.ws",".beyondmenu.com",".chamberofcommerce.com/",".dinehere.us","dineoption.com",

                  "/etapthru.com",".food96.com","/foodeist.com/",".foodpages.ca",
                  ".groupon.com","/grubhub.com",".hungryfoody.com",".offthestrip.com","/listing/",
                  ".opentable.com",".profilecanda.com",
                  "/restaurantguru.com",".restaurantji.com","restaurants.com",".singleplatform.com",".showmelocal.com",
                  ".squaremeal.co.uk","tripadvisor.",

                 ".whereorg.com/",".yellowpages.com/"];
    /* TODO should be requester #, last field should be if it's crowd or not */
    var MTurk=new MTurkScript(60000,2500+(Math.random()*1500),[],begin_script,"A2EILHT073BDZZ",false);
    ...
    function query_response(response,resolve,reject,type) {
        ...
        try
        {
            ...
            if(b_context&&(parsed_context=MTP.parse_b_context(b_context))) {
                ...
                if(type==="q2" && parsed_context.closed) {
                    reject("");
                }
                if(type==="q2" && parsed_context.url&&!MTP.is_bad_url(parsed_context.url,bad_urls,-1)) {
            ...
            for(i=0; i < b_algo.length&&i<2; i++) {
                ...
                b_url=decodeURIComponent(b_url.replace(/^.*rebates\/welcome\?url=([^\&]*).*$/,"$1"));
...
*/
    ...
    function submit_if_done() {
        ...
        if(is_done && !my_query.submitted && ( my_query.bad_count===2)) {
    ...
    function init_Query()
    {
        ...
        var car=document.querySelectorAll(".carousel-item,.panel");
        var c;
      for(c of car) {
       ...
       var name=document.querySelector("#name");
        my_query={name:document.querySelector("#name").innerText.trim(),
                  ...
                  phone:document.querySelector("#phone")?document.querySelector("#phone").innerText.trim():"",
