...
(function() {
   ...
   function add_text(text) {
    ...
    function update_address() {
        var top,x;
        var field_map={"postcode":"Zipcode","city":"City","state":"State","url":"Source URL"};
    ...
    function do_address_paste(e) {
        ...
        console.log("text="+text);
        Address.addressList.push(new Address(text,-50,document.querySelector("[name='Source URL']").value));
        add_to_sheet();
      // add_text(text);
    }
    ...
    function init_Query()
    {
        ...
        var search_str=my_query.name+" corporate headquarters";
