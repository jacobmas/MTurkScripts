// ==UserScript==
// @name         FindCompanyWebsite
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Find company website, not optimized yet
// @author       You
...
(function() {
    ...
    var MTurk=new MTurkScript(20000,750+(Math.random()*1000),[],begin_script,"AJY1MQKNT0MCH",true);
    ...
    function init_Query()
    {
        ...
        my_query={name:MTP.shorten_company_name(name),fields:{},done:{},
		  try_count:{"query":0},
		  submitted:false};
