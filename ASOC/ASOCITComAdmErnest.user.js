...
(function() {
    ...
    var my_query = {};
    var bad_urls=[];
    var MTurk=new MTurkScript(20000,200,[],begin_script,"A1PZPYT7WHUD89",false);
...
//            console.log("Email for "+i+"="+results[i].email);
    ...
    function PersonQual(curr) {
        ...
        this.quality=0;
        if(curr.title && /Principal|Dean|Head of School|Director/i.test(curr.title)) {
            this.type="Administration";
            if(/^(Principal|Head of School)$/i.test(curr.title)) this.quality=4;
    ...
    function init_Query() {
       ...
       // Gov.debug=true;
        ...
        text=document.querySelector(".well").innerText.split("\n");
     ...
     //   var text="SOUTH BRONX CLASSICAL CHARTER SCHOOL\n977 FOX ST\nBRONX, NY".split("\n");
       ...
       query.name=query.name.replace(/-.*$/," ").replace(/ St /i," Street ")
        ...
        my_query={name:query.name,fields:{first_name:"",last_name:"",email:""},checkboxes:{title:0},done:{},submitted:false};
        ...
        var promise=new Promise((resolve,reject) => {
            s=new School({name:query.name,city:query.city,state:query.state,type:"school",
                              title_str:["Principal","Head of School","Director","Dean"],
                              debug:true,
                             title_regex:[/Principal|Director|Head of School|Dean/i]},resolve,reject);
        ...
        promise.then(function(self) {
            ...
            if(result.length>0) {
                ...
                if(/Principal/.test(curr.title)) my_query.checkboxes.title=0;
                else if(/Director/.test(curr.title)) my_query.checkboxes.title=1;
                else my_query.checkboxes.title=2;
            }
