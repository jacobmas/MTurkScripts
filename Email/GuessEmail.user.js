...
(function() {
       ...
       console.log(response.finalUrl);
        ...
        try
        {
            ...
            for(i=0; i < b_algo.length && i < 6; i++)
            {
                ...
                {
                    resolve(JSON.stringify({domain: get_domain_only(b_url), url: b_url}));
                    return;
  ...
  function query_search(search_str, resolve,reject, callback) {
    ...
    function init_Query()
    {
        ...
        my_query={fname: wT.rows[0].cells[1].innerText, mname:"", lname: wT.rows[1].cells[1].innerText.split(" ")[0],title:wT.rows[2].cells[1].innerText,
                  orgname: wT.rows[3].cells[1].innerText};
